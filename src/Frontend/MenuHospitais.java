...
private AbstractTableModel criarTabela() {   
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Equipamentos ocupados:");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int row = tabHospital.getSelectedRow();
        Hospital h = sist.getListaHoospitais().getHospital(row);
        new EditarHospital(sist, user, h).setVisible(true);
        this.dispose();
    ...
    private void atualizarEnf(Hospital h){
        ...
        int y=0;
        try{
            for(Enfermaria enf: h.getListaEnfermaria()){
                for(Equipamento e : enf.getListaEquipamento()){
            ...
            String equipOcupados = String.valueOf(y);
            jLabel16.setText(equipOcupados);
        }
        catch(Exception NullPointerException){
